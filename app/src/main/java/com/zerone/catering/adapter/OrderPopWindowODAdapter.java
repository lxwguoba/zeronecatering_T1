...
public class OrderPopWindowODAdapter extends BaseAdapter {

    private Context context ;
    private List<OrderType> list;
    public OrderPopWindowODAdapter(Context context, List<OrderType>  list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.pName.setText(list.get(position).getTypeName());
        return convertView;
    }
